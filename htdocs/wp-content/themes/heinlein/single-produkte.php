   ...
   <div class="content--max" id="produktanfrage">
      <a class="pop-produktanfrage" href="#">
         <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 280 300" style="width:280px" xml:space="preserve">
            ...
            <text transform="matrix(1 0 0 1 29.55 195.5587)"><tspan x="0" y="0" style="fill:#FFFFFF; font-family:'Encode Sans Expanded'; font-size:15px;"><?php echo _e("Wir antworten"); ?></tspan><tspan x="0" y="23" style="fill:#FFFFFF; font-family:'EncodeSansExpanded-Regular'; font-size:15px;"><?php echo _e("innerhalb von 24h"); ?></tspan></text>
